export const pt_BR = {
  ...
  salutation: {
    ...
    myname: 'Projetoooo, escrevo e desenvolvo soluções web e mobile',
  ...
  know: {
    ...
    css: 'CSS, uma linguagem de folha de estilo, é utilizada para estilizar e dar formato às páginas, facilitando a criação de layouts atraentes.',
